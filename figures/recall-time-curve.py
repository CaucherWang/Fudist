...
seanet_path = os.path.join(path, f'{dataset}_ef{ef}_M{M}_SEANet.log')
...
ticks = {
    'deep': [[0.5,1.0,1.5,2.0], [92,94,96,98,100]],
    'word2vec': [[5,15,25,35], [80,84,88,92,96]],
    'imagenet': [[5,15,25,35], [80,84,88,92,96]],
    'trevi': [[0,5,10,15,20,25], [88,92,96,100]],
    'mnist': [[0.2, 0.6,1.0,1.4], [96,97,98,99,100]],
    'gist': [[5,15,25,35], [75,85,95,100]]
}
